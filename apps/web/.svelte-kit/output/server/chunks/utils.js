...
async function deserialize_binary_form(request) {
  if (
    request.headers.get("content-type") !== "application/x-sveltekit-formdata"
  ) {
...
//#endregion
export {
  MUTATIVE_METHODS as C,
  ENDPOINT_METHODS as S,
  SVELTE_KIT_ASSETS as T,
  deserialize_binary_form as _,
  handle_error_and_jsonify as a,
  set_nested_value as b,
  method_not_allowed as c,
  static_error_page as d,
  escape_html as f,
  deep_set as g,
  create_field_proxy as h,
  get_node_type as i,
  redirect_response as l,
  negotiate as m,
  format_server_error as n,
  handle_fatal_error as o,
  is_form_content_type as p,
  get_global_name as r,
  has_prerendered_path as s,
  clarify_devalue_error as t,
  serialize_uses as u,
  flatten_issues as v,
  PAGE_METHODS as w,
  throw_on_old_property_access as x,
